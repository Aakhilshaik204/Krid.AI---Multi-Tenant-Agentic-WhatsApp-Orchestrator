  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        onClick={() => setOpen(o => !o)}
        className="flex items-center gap-2.5 px-3 py-2 bg-white border border-slate-200
                   rounded-lg text-sm hover:bg-slate-50 hover:border-slate-300
                   transition-all duration-150 shadow-card min-w-[200px]"
      >
      ...
      {open && (
        <div className="absolute top-full mt-1.5 left-0 w-64 card-md rounded-xl py-1 z-50 animate-slide-up">
