    ...
    extend: {
      ...
      colors: {
        brand: {
          ...
          300: '#a5b8fc', 400: '#818ef8', 500: '#5b6af4',
          600: '#4550e8', 700: '#3840ce', 800: '#2e34a6',
          900: '#1e2266', 950: '#111440',
        },
        slate: {
      ...
      boxShadow: {
        ...
        'glow-sm':  '0 0 12px rgba(91,106,244,0.25)',
        'glow-md':  '0 0 24px rgba(91,106,244,0.3)',
        'ring-brand':'0 0 0 3px rgba(91,106,244,0.15)',
      },
      animation: {
        /* entrances */
