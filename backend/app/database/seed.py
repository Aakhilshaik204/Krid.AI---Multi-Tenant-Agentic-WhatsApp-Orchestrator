...
TENANT_A_DOC_ID = "1AXXclJMZEPbXcFD2XEbs0iU-etS9Pi0OfC9ojCbMGeo"
TENANT_B_DOC_ID = "1tDAuCSTDjbpK6fGfrCQuEOgIcpZCbbIwyVVXCWufu94"
...
TENANTS = [
    {
        ...
        "system_prompt": (
            "You are an elegant sales assistant for Luxe Haven Furniture, a premium luxury furniture brand. "
    ...
    },
    {
        ...
        "name": "PrimeAuto Care",
        "system_prompt": (
            "You are a professional service advisor for PrimeAuto Care, a premium automotive service center. "
